...
function CanvasState(canvas)
{
	...
	canvas.addEventListener('mouseup', function(e)
	{
		if (!myState.is_hidden)
		{
			...
			{
				myState.onChange( myState.shapes, myState.selection );
	...
	canvas.addEventListener('dblclick', function(e)
	{
		...
		{
			var mouse = myState.getMouse(e);
			myState.addShape(new Shape(myState, mouse.x - 20, mouse.y - 20, 40, 40, 'rgba(0,255,0,.6)'));
			myState.onChange( myState.shapes, myState.selection );
		}
...
CanvasState.prototype.removeShape = function(shape)
{
	...
	// console.log (this.shapes[the_index]);
	this.selection = null;
...
CanvasState.prototype.hide = function()
{
	this.clear();
	this.is_hidden = true;
};

CanvasState.prototype.show = function()
{
	this.is_hidden = false;
	this.valid = false;
};
